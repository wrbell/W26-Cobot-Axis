...
Detailed protocol specifications are drawn from the project research document (`tech_docs/UR30/ur_rtde_research.md`, Sections 4 and 6).
...
Register allocation details are specified in `tech_docs/UR30/ur_rtde_research.md`, Section 3.4.
...
- Project research document: `tech_docs/UR30/ur_rtde_research.md`
