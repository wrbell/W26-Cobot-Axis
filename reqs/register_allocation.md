...
This document finalizes the RTDE register mapping between the UR30 controller and the Pi (RTDE bridge daemon). The proposed mapping from `tech_docs/UR30/ur_rtde_research.md` Section 3.4 is adopted with minor refinements.
